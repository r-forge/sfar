...
cLCMhalfnormlike4C <- function(parm, nXvar, nuZUvar, nvZVvar, uHvar,
  ...
  theta3 <- parm[(4 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 2 *
    nZHvar + 1):(4 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 3 *
    nZHvar)]
...
chessLCMhalfnormlike4C <- function(parm, nXvar, nuZUvar, nvZVvar,
  ...
  hessll[1:nXvar, (4 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 2 *
    nZHvar + 1):(4 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 3 *
  ...
  hessll[(nXvar + 1):(nXvar + nuZUvar), (4 * nXvar + 4 * nuZUvar +
    4 * nvZVvar + nZHvar + 1):(4 * nXvar + 4 * nuZUvar + 4 *
  ...
  hessll[(nXvar + 1):(nXvar + nuZUvar), (4 * nXvar + 4 * nuZUvar +
    ...
    4 * nvZVvar + 3 * nZHvar)] <- crossprod(sweep(uHvar, MARGIN = 1,
  ...
  hessll[(nXvar + nuZUvar + 1):(nXvar + nuZUvar + nvZVvar), (4 *
    ...
    vHvar)
  hessll[(nXvar + nuZUvar + 1):(nXvar + nuZUvar + nvZVvar), (4 *
    nXvar + 4 * nuZUvar + 4 * nvZVvar + 1):(4 * nXvar + 4 *
    nuZUvar + 4 * nvZVvar + nZHvar)] <- crossprod(sweep(vHvar,
    MARGIN = 1, STATS = sigx4w2z * ewv1 * ewz1 * sigx7_1/sqrt(sigma_sq1),
    FUN = "*"), Zvar)
  hessll[(nXvar + nuZUvar + 1):(nXvar + nuZUvar + nvZVvar), (4 *
    nXvar + 4 * nuZUvar + 4 * nvZVvar + nZHvar + 1):(4 * nXvar +
    4 * nuZUvar + 4 * nvZVvar + 2 * nZHvar)] <- crossprod(sweep(vHvar,
    MARGIN = 1, STATS = -(sigx4wz * ewv1 * ewz1 * ewz2 *
      sigx7_1/sqrt(sigma_sq1)), FUN = "*"), Zvar)
  hessll[(nXvar + nuZUvar + 1):(nXvar + nuZUvar + nvZVvar), (4 *
    nXvar + 4 * nuZUvar + 4 * nvZVvar + 2 * nZHvar + 1):(4 *
    nXvar + 4 * nuZUvar + 4 * nvZVvar + 3 * nZHvar)] <- crossprod(sweep(vHvar,
  ...
  hessll[(nXvar + nuZUvar + nvZVvar + 1):(2 * nXvar + nuZUvar +
    ...
    FUN = "*"), Zvar)
  hessll[(nXvar + nuZUvar + nvZVvar + 1):(2 * nXvar + nuZUvar +
    nvZVvar), (4 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 2 * nZHvar +
    1):(4 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 3 * nZHvar)] <- crossprod(sweep(Xvar,
  ...
  hessll[(2 * nXvar + nuZUvar + nvZVvar + 1):(2 * nXvar + 2 *
    nuZUvar + nvZVvar), (4 * nXvar + 4 * nuZUvar + 4 * nvZVvar +
    nZHvar + 1):(4 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 2 *
    nZHvar)] <- crossprod(sweep(uHvar, MARGIN = 1, STATS = sigx4w4z *
  ...
  hessll[(2 * nXvar + 2 * nuZUvar + nvZVvar + 1):(2 * nXvar +
    ...
    nvZVvar + 1):(4 * nXvar + 4 * nuZUvar + 4 * nvZVvar + nZHvar)] <- crossprod(sweep(vHvar,
    MARGIN = 1, STATS = -(sigx4w3z * ewv2 * ewz1 * ewz2 *
      sigx7_2/sqrt(sigma_sq2)), FUN = "*"), Zvar)
  hessll[(2 * nXvar + 2 * nuZUvar + nvZVvar + 1):(2 * nXvar +
    2 * nuZUvar + 2 * nvZVvar), (4 * nXvar + 4 * nuZUvar + 4 *
    nvZVvar + nZHvar + 1):(4 * nXvar + 4 * nuZUvar + 4 * nvZVvar +
    2 * nZHvar)] <- crossprod(sweep(vHvar, MARGIN = 1, STATS = sigx4w4z *
    ewv2 * ewz2 * sigx7_2/sqrt(sigma_sq2), FUN = "*"), Zvar)
  hessll[(2 * nXvar + 2 * nuZUvar + nvZVvar + 1):(2 * nXvar +
    2 * nuZUvar + 2 * nvZVvar), (4 * nXvar + 4 * nuZUvar + 4 *
    nvZVvar + 2 * nZHvar + 1):(4 * nXvar + 4 * nuZUvar + 4 *
  ...
  hessll[(2 * nXvar + 2 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar +
    2 * nuZUvar + 2 * nvZVvar), (4 * nXvar + 4 * nuZUvar + 4 *
    nvZVvar + 1):(4 * nXvar + 4 * nuZUvar + 4 * nvZVvar + nZHvar)] <- crossprod(sweep(Xvar,
  ...
  hessll[(3 * nXvar + 2 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar +
    ...
    nvZVvar + 1):(4 * nXvar + 4 * nuZUvar + 4 * nvZVvar + nZHvar)] <- crossprod(sweep(uHvar,
    MARGIN = 1, STATS = -(sigx4w3z * ewu3 * ewz1 * ewz3 *
      sigx6_3/sqrt(sigma_sq3)), FUN = "*"), Zvar)
  hessll[(3 * nXvar + 2 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar +
    3 * nuZUvar + 2 * nvZVvar), (4 * nXvar + 4 * nuZUvar + 4 *
    nvZVvar + nZHvar + 1):(4 * nXvar + 4 * nuZUvar + 4 * nvZVvar +
    2 * nZHvar)] <- crossprod(sweep(uHvar, MARGIN = 1, STATS = -(sigx4wz *
  ...
  hessll[(3 * nXvar + 3 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar +
    3 * nuZUvar + 3 * nvZVvar), (4 * nXvar + 4 * nuZUvar + 4 *
    nvZVvar + nZHvar + 1):(4 * nXvar + 4 * nuZUvar + 4 * nvZVvar +
    2 * nZHvar)] <- crossprod(sweep(vHvar, MARGIN = 1, STATS = -(sigx4wz *
  ...
  hessll[(4 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 1):(4 * nXvar +
    4 * nuZUvar + 4 * nvZVvar + nZHvar), (4 * nXvar + 4 * nuZUvar +
    4 * nvZVvar + 1):(4 * nXvar + 4 * nuZUvar + 4 * nvZVvar +
  ...
  hessll[(4 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 1):(4 * nXvar +
    4 * nuZUvar + 4 * nvZVvar + nZHvar), (4 * nXvar + 4 * nuZUvar +
    4 * nvZVvar + 2 * nZHvar + 1):(4 * nXvar + 4 * nuZUvar +
    4 * nvZVvar + 3 * nZHvar)] <- crossprod(sweep(Zvar, MARGIN = 1,
    STATS = -(((2 * dpsq1 - sigx4)/(sigx4wzsq) + 2 * ((2 *
      dpsq3 - sigx4) * depsisq1 * pmusig1/(wzdsig^2 * sqrt(sigma_sq1)))) *
      ewz1 * ewz3), FUN = "*"), Zvar)
  hessll[(4 * nXvar + 4 * nuZUvar + 4 * nvZVvar + nZHvar + 1):(4 *
    nXvar + 4 * nuZUvar + 4 * nvZVvar + 2 * nZHvar), (4 * nXvar +
    4 * nuZUvar + 4 * nvZVvar + nZHvar + 1):(4 * nXvar + 4 *
  ...
  hessll[(4 * nXvar + 4 * nuZUvar + 4 * nvZVvar + nZHvar + 1):(4 *
    nXvar + 4 * nuZUvar + 4 * nvZVvar + 2 * nZHvar), (4 * nXvar +
    4 * nuZUvar + 4 * nvZVvar + 2 * nZHvar + 1):(4 * nXvar +
  ...
  hessll[(4 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 2 * nZHvar +
    ...
    (4 * nXvar + 4 * nuZUvar + 4 * nvZVvar + 2 * nZHvar + 1):(4 *
      nXvar + 4 * nuZUvar + 4 * nvZVvar + 3 * nZHvar)] <- crossprod(sweep(Zvar,

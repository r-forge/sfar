...
#' @title Returning conditional (in-)efficiency estimates
#'
#' @name efficiencies
#'
#' @aliases efficiencies.sfacross
#'
#' @description This method returns (in-)efficiency estimates from (latent
...
#' @param indataTable Logical. If \code{TRUE}, (in)efficiency scores are
...
#'
#' @details Conditional inefficiency are obtained following Jondrow \emph{et
...
#'
#'  - The Battese and Coelli (1988) conditional efficiency score is obtained by:
#'
...
#'
#'  - The confidence intervals are obtained by:
#'
...
#'
#' @return A dataframe that contains (in-)efficiency estimates.
#'

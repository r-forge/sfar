...
cLCMhalfnormlike3C <- function(parm, nXvar, nuZUvar, nvZVvar, uHvar,
...
chessLCMhalfnormlike3C <- function(parm, nXvar, nuZUvar, nvZVvar,
  ...
  hessll[(nXvar + 1):(nXvar + nuZUvar), (3 * nXvar + 3 * nuZUvar +
    3 * nvZVvar + nZHvar + 1):(3 * nXvar + 3 * nuZUvar + 3 *
  ...
  hessll[(nXvar + nuZUvar + 1):(nXvar + nuZUvar + nvZVvar), (3 *
    ...
    vHvar)
  hessll[(nXvar + nuZUvar + 1):(nXvar + nuZUvar + nvZVvar), (3 *
    nXvar + 3 * nuZUvar + 3 * nvZVvar + 1):(3 * nXvar + 3 *
    nuZUvar + 3 * nvZVvar + nZHvar)] <- crossprod(sweep(vHvar,
    MARGIN = 1, STATS = sigx4w2z * ewv1 * ewz1 * sigx7_1/sqrt(sigma_sq1),
    FUN = "*"), Zvar)
  hessll[(nXvar + nuZUvar + 1):(nXvar + nuZUvar + nvZVvar), (3 *
    nXvar + 3 * nuZUvar + 3 * nvZVvar + nZHvar + 1):(3 * nXvar +
    3 * nuZUvar + 3 * nvZVvar + 2 * nZHvar)] <- crossprod(sweep(vHvar,
  ...
  hessll[(2 * nXvar + nuZUvar + nvZVvar + 1):(2 * nXvar + 2 *
    nuZUvar + nvZVvar), (3 * nXvar + 3 * nuZUvar + 3 * nvZVvar +
    nZHvar + 1):(3 * nXvar + 3 * nuZUvar + 3 * nvZVvar + 2 *
  ...
  hessll[(2 * nXvar + 2 * nuZUvar + nvZVvar + 1):(2 * nXvar +
    ...
    nvZVvar + 1):(3 * nXvar + 3 * nuZUvar + 3 * nvZVvar + nZHvar)] <- crossprod(sweep(vHvar,
    MARGIN = 1, STATS = -(sigx4w3z * ewv2 * ewz1 * ewz2 *
      sigx7_2/sqrt(sigma_sq2)), FUN = "*"), Zvar)
  hessll[(2 * nXvar + 2 * nuZUvar + nvZVvar + 1):(2 * nXvar +
    2 * nuZUvar + 2 * nvZVvar), (3 * nXvar + 3 * nuZUvar + 3 *
    nvZVvar + nZHvar + 1):(3 * nXvar + 3 * nuZUvar + 3 * nvZVvar +
  ...
  hessll[(2 * nXvar + 2 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar +
    2 * nuZUvar + 2 * nvZVvar), (3 * nXvar + 3 * nuZUvar + 3 *
    nvZVvar + 1):(3 * nXvar + 3 * nuZUvar + 3 * nvZVvar + nZHvar)] <- crossprod(sweep(Xvar,
  ...
  hessll[(3 * nXvar + 2 * nuZUvar + 2 * nvZVvar + 1):(3 * nXvar +
    ...
    nvZVvar + 1):(3 * nXvar + 3 * nuZUvar + 3 * nvZVvar + nZHvar)] <- crossprod(sweep(uHvar,
  ...
  hessll[(3 * nXvar + 3 * nuZUvar + 3 * nvZVvar + 1):(3 * nXvar +
    3 * nuZUvar + 3 * nvZVvar + nZHvar), (3 * nXvar + 3 * nuZUvar +
    3 * nvZVvar + 1):(3 * nXvar + 3 * nuZUvar + 3 * nvZVvar +
  ...
  hessll[(3 * nXvar + 3 * nuZUvar + 3 * nvZVvar + 1):(3 * nXvar +
    ...
    STATS = -(((2 * dpsq1 - sigx4)/(sigx4wzsq) + 2 * ((2 *
      ...
      ewz1 * ewz2), FUN = "*"), Zvar)
  hessll[(3 * nXvar + 3 * nuZUvar + 3 * nvZVvar + nZHvar + 1):(3 *
    nXvar + 3 * nuZUvar + 3 * nvZVvar + 2 * nZHvar), (3 * nXvar +
    3 * nuZUvar + 3 * nvZVvar + nZHvar + 1):(3 * nXvar + 3 *
